...
ENUM_NEXT(notify_type_names, SINGLE_PAIR_REQUIRED, CHILD_SA_NOT_FOUND, AUTHENTICATION_FAILED,
	...
	"TEMPORARY_FAILURE",
	"CHILD_SA_NOT_FOUND");
ENUM_NEXT(notify_type_names, TS_MAX_QUEUE, TS_MAX_QUEUE, CHILD_SA_NOT_FOUND,
	"TS_MAX_QUEUE");
...
ENUM_NEXT(notify_type_names, USE_PPK, NO_PPK_AUTH, SIGNATURE_HASH_ALGORITHMS,
	...
	"PPK_IDENTITY",
	"NO_PPK_AUTH");
ENUM_NEXT(notify_type_names, SA_RESOURCE_INFO, SA_RESOURCE_INFO, NO_PPK_AUTH,
	"SA_RESOURCE_INFO");
...
ENUM_NEXT(notify_type_short_names, SINGLE_PAIR_REQUIRED, CHILD_SA_NOT_FOUND, AUTHENTICATION_FAILED,
	...
	"TEMP_FAIL",
	"NO_CHILD_SA");
ENUM_NEXT(notify_type_short_names, TS_MAX_QUEUE, TS_MAX_QUEUE, CHILD_SA_NOT_FOUND,
	"MAX_QUEUE");
...
ENUM_NEXT(notify_type_short_names, USE_PPK, NO_PPK_AUTH, SIGNATURE_HASH_ALGORITHMS,
	...
	"PPK_ID",
	"NO_PPK");
ENUM_NEXT(notify_type_short_names, SA_RESOURCE_INFO, SA_RESOURCE_INFO, NO_PPK_AUTH,
	"RES_INFO");
